            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="player.eligible.label" default="Eligible" /></td>
                            
                            <td valign="top" class="value"><g:formatBoolean boolean="${playerInstance?.eligible}" /></td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="player.gameType.label" default="Game Type" /></td>
                            
                            <td valign="top" class="value">${playerInstance?.gameType?.encodeAsHTML()}</td>
